...
而我解决的 [JDK-8254557](https://bugs.openjdk.java.net/browse/JDK-8254557) 则是在OpenJDK11、14、15、16(9和10已经不再维护，14也将不再维护)都出现的问题，然而我的补丁也只是提交到开发主线(当前的开发主线OpenJDK16)，也就是说JDK11、14、15还是没有解决这个问题的。
